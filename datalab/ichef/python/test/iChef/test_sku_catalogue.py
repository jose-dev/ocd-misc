...
class SkuCatalogueTest(unittest.TestCase):
    ...
    def test_create_sku_catalogue_with_two_sku(self):
        sku_1 = Sku(id="sku_001", description="main sku 1")
        sku_2 = Sku(id="sku_002", description="main sku 2")
        sku_catalogue = SkuCatalogue()
        sku_catalogue.add_sku(sku_1)
        sku_catalogue.add_sku(sku_2)
