...
def generate_single_pick_part(ContainerId=random_string(),
...
def generate_whole_pick_part(StoreId=None,
                             PickwalkId=None,
                             PickerId=None,
    ...
    for n in range(0, no_objects):
        ...
        for tray in trolley.keys():
            ...
            if quantity > 0:
                ...
                picks.append(generate_single_pick_part(ContainerId=trolley[tray]["container_id"],
        ...
        pick_object = generate_whole_pick_part(StoreId=store_id,
